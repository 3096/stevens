...
bool add_title(void)
{
 // title
 STDSTRING p1;
 p1 += TEXT("[PC] Attack on Titan: Wings of Freedom");

 // instructions
 STDSTRING p2;
 p2 += TEXT("1. Copy BIN files from game into a new folder.\n");
 ...
 p3 += TEXT("2. You need ~41 GB of free space.\n");
 p3 += TEXT("3. 15 GB for game + 26 GB for extraction.\n");
