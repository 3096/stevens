...
bool add_title(void)
{
 // title
 STDSTRING p1;
 p1 += TEXT("[PS3] Bladestorm Hyakunen Sensou and Nightmare");
 ...
 p2 += TEXT("4. Select folder where LINKDATA0.IDX file is.\n");
 p2 += TEXT("5. Click OK.\n");
 ...
 p3 += TEXT("2. You need 6 GB free space.\n");
 p3 += TEXT("3. 3 GB for game data + 3 GB extraction.");
...
bool extract(LPCTSTR pname)
{
 ...
 // questions
 if(doIDX) doIDX = YesNoBox("Process LINKDATA0.IDX file?");
