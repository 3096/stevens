...
#define XBDM_PMCSESSIONALREADYACTIVE XBDM_HRESERR(44)
#define XBDM_PMCSESSIONNOTACTIVE XBDM_HRESERR(45)
#define XBDM_LINE_TOO_LONG XBDM_HRESERR(46)
...
#define XBDM_RESULTCODE XBDM_HRESSUCC(9)
