...
bool add_title(void)
{
 // title
 STDSTRING p1;
 p1 += TEXT("[PC] Dragon Quest Heroes Slime Edition");
 ...
 p3 += TEXT("2. You need 22 GB free space.\n");
 p3 += TEXT("3. 6 GB for game + 16 GB extraction.\n");
...
bool extract(LPCTSTR pname)
{
 ...
 if(doDLC) doDLC = YesNoBox("Process files in DLC folder?\nSay 'No' if you have already done this before.");
